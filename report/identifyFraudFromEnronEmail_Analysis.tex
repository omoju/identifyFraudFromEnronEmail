...
For our implementation, we used a baseline classifier, we fitted it to our data and used its ``\texttt{feature\_importances\_}'' to obtain a score on the strength of that feature. We ran this algorithm a 1000 and averaged the scores of the features to obtain the top $n$ features.
...
\begin{table}[!htbp]
\caption{Result of training with baseline \textbf{Learners}} %title of the table
