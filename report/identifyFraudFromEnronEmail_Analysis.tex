...
\centering
    ...
    \caption{\textbf{Person of Interest plot.}\textit{The histograms shows an unbalanced target dataset with approximately 112 values of \{0 - not POI\} and 18 values of \{1 - POI\}.}}
\end{figure}
